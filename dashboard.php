    ...
    <td>
      <div class="dropdown">
        <!-- tombol dropdown untuk pilihan -->
         <button type="button" class="btn p-0 dropdown-tonggle hide-arrow" data-bs-tonggle="dropdown">
